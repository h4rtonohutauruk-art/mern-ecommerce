...
const GiftCouponCart = () => {
  ...
  useEffect(() => {
    if (coupon?.code && userInputCode !== coupon.code) {
      setUserInputCode(coupon.code);
    }
  }, [coupon, userInputCode]);

  const handleApplyCoupon = () => {
    // console.log(userInputCode);
    if (!userInputCode || userInputCode === "") return;
    console.log("frontend code applied : ", userInputCode);
